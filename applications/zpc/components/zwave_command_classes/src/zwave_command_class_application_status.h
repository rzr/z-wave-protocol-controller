...
#ifndef ZWAVE_COMMAND_CLASS_APPLICATION_STATUS_H
#define ZWAVE_COMMAND_CLASS_APPLICATION_STATUS_H
...
/**
 * @brief This function initialize the Application Status Command Class handler
 *
...
#endif  //ZWAVE_COMMAND_CLASS_APPLICATION_STATUS_H
/** @} end zwave_command_class_application_status */
