...
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_SUPPORT_ADMIN_PIN_CODE,
                 ((COMMAND_CLASS_USER_CREDENTIAL << 8) | 0x0A))
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_SUPPORT_ADMIN_PIN_CODE_DEACTIVATION,
...
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_USER_EXPIRING_TIMEOUT_MINUTES,
                 ((COMMAND_CLASS_USER_CREDENTIAL << 8) | 0x24))

// Specific to Credential Learn
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_LEARN_OPERATION_TYPE,
                 ((COMMAND_CLASS_USER_CREDENTIAL << 8) | 0x25))
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_LEARN_TIMEOUT,
                 ((COMMAND_CLASS_USER_CREDENTIAL << 8) | 0x26))
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_LEARN_STATUS,
                 ((COMMAND_CLASS_USER_CREDENTIAL << 8) | 0x27))
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_LEARN_STEPS_REMAINING,
                 ((COMMAND_CLASS_USER_CREDENTIAL << 8) | 0x28))
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_LEARN_STOP,
                 ((COMMAND_CLASS_USER_CREDENTIAL << 8) | 0x29))

// Specific to Credential User Unique Identifier Credential (UUIC) Association
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_ASSOCIATION_DESTINATION_USER_ID,
                 ((COMMAND_CLASS_USER_CREDENTIAL << 8) | 0x2A))
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_ASSOCIATION_DESTINATION_CREDENTIAL_SLOT,
                 ((COMMAND_CLASS_USER_CREDENTIAL << 8) | 0x2B))
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_ASSOCIATION_STATUS,
                 ((COMMAND_CLASS_USER_CREDENTIAL << 8) | 0x2C))

// Checksums
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_USER_CHECKSUM,
                 ((COMMAND_CLASS_USER_CREDENTIAL << 8) | 0x2D))
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_USER_CHECKSUM_MISMATCH_ERROR,
                 ((COMMAND_CLASS_USER_CREDENTIAL << 8) | 0x2E))
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_CHECKSUM,
                 ((COMMAND_CLASS_USER_CREDENTIAL << 8) | 0x2F))
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_CHECKSUM_MISMATCH_ERROR,
                 ((COMMAND_CLASS_USER_CREDENTIAL << 8) | 0x30))

// Admin Code
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_ADMIN_PIN_CODE,
                 ((COMMAND_CLASS_USER_CREDENTIAL << 8) | 0x31))
DEFINE_ATTRIBUTE(ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_ADMIN_PIN_CODE_OPERATION_RESULT,
