...
static const std::vector<attribute_schema_t> attribute_schema = {
  ...
  // Credential Checksum is under the Credential Type not Credential Slot
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_CHECKSUM, "User Credential Credential Checksum", ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_TYPE, U16_STORAGE_TYPE},
