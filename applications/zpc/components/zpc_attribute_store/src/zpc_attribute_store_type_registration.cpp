...
static const std::vector<attribute_schema_t> attribute_schema = {
  ...
  // V1+ Report
  {ATTRIBUTE_COMMAND_CLASS_BATTERY_BATTERY_LEVEL,   "Battery Level",   ATTRIBUTE_ENDPOINT_ID,   U8_STORAGE_TYPE},
  // V2+ report
  {ATTRIBUTE_COMMAND_CLASS_BATTERY_CHARGING_STATUS, "Charging status", ATTRIBUTE_ENDPOINT_ID, U8_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_BATTERY_RECHARGEABLE, "Rechargeable", ATTRIBUTE_ENDPOINT_ID, U8_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_BATTERY_BACKUP_BATTERY, "Backup battery", ATTRIBUTE_ENDPOINT_ID, U8_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_BATTERY_OVERHEATING, "Battery Overheating", ATTRIBUTE_ENDPOINT_ID, U8_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_BATTERY_LOW_FLUID, "Battery Low Fluid", ATTRIBUTE_ENDPOINT_ID, U8_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_BATTERY_REPLACE_RECHARGE, "Replace/Recharge Bitmask", ATTRIBUTE_ENDPOINT_ID, U8_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_BATTERY_DISCONNECTED, "Battery Disconnected", ATTRIBUTE_ENDPOINT_ID, U8_STORAGE_TYPE},
  // V3+ report
  ...
  {ATTRIBUTE_COMMAND_CLASS_BATTERY_HEALTH_BATTERY_TEMPERATURE, "Battery Temperature", ATTRIBUTE_ENDPOINT_ID, I32_STORAGE_TYPE},
  ...
  {ATTRIBUTE_COMMAND_CLASS_NOTIFICATION_PROBE_ACTIVE, "Pull probe active", ATTRIBUTE_ENDPOINT_ID, U8_STORAGE_TYPE},
  /////////////////////////////////////////////////////////////////////
  ...
  {ATTRIBUTE_COMMAND_CLASS_THERMOSTAT_SETPOINT_SUPPORTED_SETPOINT_TYPES,   "Thermostat Supported Setpoint Types",   ATTRIBUTE_ENDPOINT_ID,  U32_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_THERMOSTAT_SETPOINT_TYPE,   "Thermostat Setpoint Type",   ATTRIBUTE_ENDPOINT_ID,   U8_STORAGE_TYPE},
  ...
  {ATTRIBUTE_COMMAND_CLASS_THERMOSTAT_SETPOINT_VALUE_SCALE,   "Value Scale",   ATTRIBUTE_COMMAND_CLASS_THERMOSTAT_SETPOINT_TYPE,   U8_STORAGE_TYPE},
  ...
  {ATTRIBUTE_COMMAND_CLASS_THERMOSTAT_SETPOINT_MIN_VALUE_SCALE,   "Min Value Scale",   ATTRIBUTE_COMMAND_CLASS_THERMOSTAT_SETPOINT_TYPE,   U8_STORAGE_TYPE},
  ...
  {ATTRIBUTE_COMMAND_CLASS_THERMOSTAT_SETPOINT_MAX_VALUE_SCALE,   "Max Value Scale",   ATTRIBUTE_COMMAND_CLASS_THERMOSTAT_SETPOINT_TYPE,   U8_STORAGE_TYPE},
  ...
  {ATTRIBUTE_COMMAND_CLASS_THERMOSTAT_SETPOINT_USE_B_INTERPRETATION,  "Use B Interpretation for Supported Setpoint Types",   ATTRIBUTE_COMMAND_CLASS_THERMOSTAT_SETPOINT_SUPPORTED_SETPOINT_TYPES,  U8_STORAGE_TYPE},
  ...
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_SUPPORT_ADMIN_PIN_CODE,   "User Credential Support Credential Admin Code",   ATTRIBUTE_ENDPOINT_ID,   U8_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_SUPPORT_ADMIN_PIN_CODE_DEACTIVATION,   "User Credential Support Admin Code Deactivation",   ATTRIBUTE_ENDPOINT_ID,   U8_STORAGE_TYPE},
  ...
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_MIN_LENGTH,   "User Credential Min Length",   ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_SUPPORTED_CREDENTIAL_TYPE,  U8_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_MAX_LENGTH,   "User Credential Max Length",   ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_SUPPORTED_CREDENTIAL_TYPE,  U8_STORAGE_TYPE},
  ...
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_CHECKSUM,  "User Credential Credential Checksum",   ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_SUPPORTED_CREDENTIAL_TYPE,  U16_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_CHECKSUM_MISMATCH_ERROR, "User Credential Credential Checksum Mismatch Error (computed by zpc)",   ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_SUPPORTED_CREDENTIAL_TYPE,  U16_STORAGE_TYPE},
  ...
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_USER_CHECKSUM, "User Credential User Checksum", ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_USER_UNIQUE_ID, U16_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_USER_CHECKSUM_MISMATCH_ERROR, "User Credential User Checksum Mismatch Error (computed by zpc)", ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_USER_UNIQUE_ID, U16_STORAGE_TYPE},
  ...
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_DATA, "User Credential Credential Data", ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_SLOT, BYTE_ARRAY_STORAGE_TYPE},
  ...
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_LEARN_OPERATION_TYPE, "User Credential Credential Learn Operation Type", ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_SLOT, U8_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_LEARN_TIMEOUT, "User Credential Credential Learn Timeout", ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_SLOT, U8_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_LEARN_STATUS, "User Credential Credential Learn Status", ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_SLOT, U8_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_LEARN_STEPS_REMAINING, "User Credential Credential Learn Steps Remaining", ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_SLOT, U8_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_ASSOCIATION_DESTINATION_USER_ID, "User Credential Association Destination User ID", ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_SLOT, U16_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_ASSOCIATION_DESTINATION_CREDENTIAL_SLOT, "User Credential Association Destination Credential Slot", ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_SLOT, U16_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_ASSOCIATION_STATUS, "User Credential Association Status", ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_SLOT, U8_STORAGE_TYPE},
  // Only one learn can be active at the time, so we make this attribute on the endpoint node
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_CREDENTIAL_LEARN_STOP, "User Credential Credential Learn Stop Flag", ATTRIBUTE_ENDPOINT_ID, U8_STORAGE_TYPE},

  // Admin 
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_ADMIN_PIN_CODE, "User Credential Admin Code", ATTRIBUTE_ENDPOINT_ID, BYTE_ARRAY_STORAGE_TYPE},
  {ATTRIBUTE_COMMAND_CLASS_USER_CREDENTIAL_ADMIN_PIN_CODE_OPERATION_RESULT, "User Credential Admin Code Operation Result", ATTRIBUTE_ENDPOINT_ID, U8_STORAGE_TYPE},
